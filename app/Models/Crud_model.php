...
class Crud_model extends Model {
    ...
    protected function _get_clean_value($options_or_value, $key = "") {
        ...
        if (is_string($value)) {
            ...
            if (
                preg_match('/\b(OR|AND|SELECT|TABLE|UNION(?:\s+ALL)?|INSERT|DELETE|UPDATE|EXEC|DROP|ALTER|TRUNCATE|REPLACE|LOAD_FILE|OUTFILE|INTO|GROUP\s+BY|ORDER\s+BY|HAVING|CASE|LIKE|--|#|\/\*)\b/i', $value)
